...
import "./styles.scss"
import PvkProductadd from './pvkproduct/PvkProductadd'
...
const AddPvk = () => {
    ...
    const submitCategory = async () => {
        try {
            ...
            const res = await axios.post(`${server}/pvk/add-category`, { catname, catimg, price }, { withCredentials: true })
            await Swal.fire({
                title: "Successfull",
    ...
    return (
        <div className='add-product'>
            <h1>Add Polki & Kundan & Victorian Categories</h1>
            <div className="cat-sec">
                <div className='select-cats'>
                    ...
                    <select className='selection' onChange={(e) => setSelectionName(e.target.value)}>
                        ...
                        {
                            pvk_categories.length === 0 ?
                                <option value="">No categories found</option> :

                                pvk_categories.map((c) => (
            ...
            {
                productbox ? <PvkProductadd cat={selectionName} /> : null
            }
